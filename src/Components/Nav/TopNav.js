...
const TopNav = () => {
    ...
    return (<>
        <header className="z-[2] upperHeader relative">
            ...
            >
                <div
                    className={`bg-[#fff] pt-[3.2rem] overflow-auto fixed right-0 w-[80vw] bottom-auto top-[64px] h-[calc(100%-64px)] min-[375px]:h-[calc(100%-72px)] min-[375px]:top-[72px] md:h-[calc(100%-83px)] md:top-[83px] text-left md:hidden ease-out duration-300 ${nav ? `left-[20vw]` : `left-[100%]`
                        }`}
                    style={{
                        boxShadow:
                ...
                >
                    ...
                    <div
                        className={`bg-[#fff] block w-[80vw] fixed overflow-auto  top-[64px] h-[calc(100%-64px)] min-[375px]:h-[calc(100%-72px)] min-[375px]:top-[72px] md:h-[calc(100%-83px)] bottom-auto ease-out duration-300 ${openMenu ? `right-0 left-[20vw]` : `right-[-100%] left-[100%]`
                            }`}
                        style={{
                            boxShadow:
